...
$definitions["Can suspend/unsuspend members"] = "メンバーを停止/解除出来ます";
$definitions["Cancel"] = "キャンセル";
$definitions["Change"] = "変更";
$definitions["Change %s's Permissions"] = " %sの権限を変更<strong>(注意)</strong>";
...
$definitions["Channel slug"] = "チャンネル変数(?)";
...
$definitions["HTML is allowed."] = "HTMLが許可されています";
...
$definitions["Mobile skin"] = "携帯端末のスキン";
...
$definitions["Yes"] = "はい";
$definitions["You can manage チャンネル-specific permissions on the channels page."] = "You can manage チャンネル-specific permissions on the channels page.";
...
$definitions["message.channelSlugTaken"] = "このチャンネル変数は既に使われています。";
...
$definitions["message.esoTalkUpdateAvailable"] = "更新があります。 %sが利用可能です。";
...
$definitions["message.fatalError"] = "致命的なエラーです! もう一度試すか、<a href='%1\$s' target='_blank'>ヘルプを参照</a>してください!";
...
$definitions["message.passwordEmailSent"] = "パスワードの再設定リンクをお送りしました。メールボックスを確認して下さい。";
